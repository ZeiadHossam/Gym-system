                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" onchange="getContractTypes()" id="packagetype"
                                    onfocusout="validate_PackageType()"
                                    name="PackageType">
                                <option class="hidden" disabled>Select Package Type
                                </option>
                                <?php foreach ($gym->getPackages() as $package) { ?>
                                    <option
                                        <?php if ($package->getId() == $contract->getPackage()->getId()) { ?>selected<?php } ?>
                                ...
                                <?php foreach ($gym->getPackages() as $package) {
                                    if ($package->getId() == $contract->getPackage()->getId()) {
                                        foreach ($package->getPeriod() as $period) {
                                            ...
                                            <option
                                                <?php if ($period->getId() == $contract->getPackage()->getPeriod()->getId()) { ?>selected<?php } ?>
                                                value="<?php echo $period->getId(); ?>"><?php echo $period->getPeriod() . " " . $package->getPeriodType(); ?></option>
                                        <?php }
                                    }
                                } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" value="<?php echo $contract->getEnddate(); ?>"
                                   name="MemberShipEnd" id="enddate"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?php echo $contract->getPaymentFees(); ?>" id="fees"
                                   name="ContractFees"
                                   onfocusout="calcTotalAmount(); calcAmountDue();  validate_ContractsFees()"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $contract->getAmountDue(); ?>"
                                   name="AmountDue" id="amountDue"
                                   onkeypress="return onlyNumberKey(event)" disabled>
                        </div>
                        <div class="form-group">
                            <label>Amount Due Date</label>
                            <input type="date" class="form-control" id="amountDueDate" onfocusout="validate_DueDate()"
                                   name="AmountDueDate" value="<?php echo $contract->getAmountDateDue(); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                   value="<?php echo $contract->getRemaningPackagePeriod(); ?>" disabled>
                        </div>
                        <b> notes </b>
                        <br>
                        <div class="form-group">
