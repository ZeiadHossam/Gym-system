			...
			<table id="custTable" class="addmembertable table table-bordered table-striped">
                ...
                if ($_SESSION['branch']==NULL){
					...
					<tr>
						...
						<td>
							<div class="btn-group tablebuttons">
                                <a href="/GYM/employee/viewEmployee/<?php echo $branch->getId();?>/<?php echo $employee->getId();?>" class="btn btn-secondary btn-sm" >View</a>
                                <a href="/GYM/employee/viewEditEmployee/<?php echo $branch->getId();?>/<?php echo $employee->getId();?>" class="btn btn-info btn-sm" >Edit</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group tablebuttons">
                                <a href="/GYM/employee/viewEmployee/<?php echo $_SESSION['branch'];?>/<?php echo $employee->getId();?>" class="btn btn-secondary btn-sm" >View</a>
                                <a href="/GYM/employee/viewEditEmployee/<?php echo $_SESSION['branch'];?>/<?php echo $employee->getId();?>" class="btn btn-info btn-sm" >Edit</a>
