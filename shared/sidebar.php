...
<aside class="main-sidebar sidebar-dark-info elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="public/img/logo.png" alt="GYM Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">GYM_Name</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="activecontractreports.php" class="nav-link">
                                <i class="far fa-file nav-icon"></i>
                                <p>Active Contracts</p>
                            </a>
                        </li>
                        <li class="nav-item">
							<a href="expiredcontractreports.php" class="nav-link">
                                <i class="far fa-file nav-icon"></i>
                                <p>Expired Contracts</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="salesreports.php" class="nav-link">
                                <i class="far fa-file nav-icon"></i>
                                <p>Sales</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="trainerreports.php" class="nav-link">
                                <i class="far fa-file nav-icon"></i>
                                <p>Trainer</p>
                            </a>
                        </li>
